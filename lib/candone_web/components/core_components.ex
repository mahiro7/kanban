defmodule CandoneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CandoneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CandoneWeb.Gettext, "errors", msg, opts)
    end
  end
