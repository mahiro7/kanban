defmodule CandoneWeb.PersonLiveTest do
  use CandoneWeb.ConnCase

  import Phoenix.LiveViewTest
  import Candone.ContactsFixtures

  @create_attrs %{description: "some description", first_name: "some first_name", last_name: "some last_name", middle_name: "some middle_name"}
